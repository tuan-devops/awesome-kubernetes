...
- [Kubernetes in the Cloud vs. Bare Metal - A Comparative Study of Network Costs (2025)](<Research Papers/Kubernetes in the Cloud vs. Bare Metal - A Comparative Study of Network Costs (2025).pdf>)- [Sharpening Kubernetes Audit Logs with Context Awareness (2025)](<Research Papers/Sharpening Kubernetes Audit Logs with Context Awareness (2025).pdf>)
